...
contract SignalsGovernanceTokenTest is Test, SignalsHarness {
    ...
    function setUp() public {
        signals = deploySignals(erc20VotesConfig);
        dealMockTokens();
    }
    ...
    //     address instance = factory.create(erc20VotesConfig);
    //     Signals deployedSignals = Signals(instance);

    //     assertEq(deployedSignals.underlyingToken(), erc20VotesConfig.underlyingToken);

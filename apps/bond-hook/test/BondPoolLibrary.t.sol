...
contract BondPoolLibraryTest is Test, Deployers, BondHookHarness {
    ...
    function setUp() public {
        ...
        state = bondhook.getPoolState(poolA.toId());
    }
    ...
    function test_swapAmountForConversion() public {
        ...
        uint256 amountToSwap = BondPoolLibrary._calculateSwapAmountForLiquidityConversion(
            price, maxPrice, minPrice, amountInBondToken, true
        );

...
contract UserBuyBondTest is Test, Deployers, BondHookHarness {
    ...
    function testUserBuysBond() public {
        ...
        assertGe(poolLiquidityAfter - poolLiquidity, 2_500 ether, "Pool liquidity should have increased");
    }

    function testUserBuysBondSingleCurrency() public {
        uint256 tokenId = aliceCreateBondAndWaits(50_000 ether, 50);
        ...
        // The pool should have earned profit in the form of liquidity:
        // Bought for 22_500, sold for 27_500 = 5_000 equals 2_500 liquidity as profit
        assertGe(_poolLiquidityAfter - _poolLiquidity, 2_500 ether, "Pool liquidity should have increased");

        assertGe(_daiBalanceBefore - _daiBalanceAfter, 27_500 ether, "Bob should have spent DAI (and some fees)");

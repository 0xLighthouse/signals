...
/// @notice This is a copy of LiquidityAmounts.sol from v4-core. In the original repo this file was found
/// in test/utils, which implies it should be considered non-criticial and possibly subject to change. It
/// is copied here so we can ensure future availability.

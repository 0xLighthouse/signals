...
import { generateTicks } from '../chart'
...
describe('chart', () => {
  it('generates basic chart data', () => {
    ...
    const ticks = generateTicks(EXISTING_DATA, {initiative, acceptanceThreshold: 1_500_000, chartInterval: LOCK_INTERVAL})
  ...
  it('generates chart data with passing threshold', () => {
    ...
    const ticks = generateTicks(EXISTING_DATA, {initiative, acceptanceThreshold: 700_000, chartInterval: LOCK_INTERVAL})

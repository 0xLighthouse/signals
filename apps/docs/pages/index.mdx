...
- [Board Configuration](/configuration/board-configuration) - Configure all board parameters including proposal requirements, release timelock, and closure options

...
See [Example Configurations](/reference/board-configuration/example-configurations) for more complete configurations with rationale, or [Board Deployment Parameters](/reference/board-configuration/config-parameters) for the full parameter reference.

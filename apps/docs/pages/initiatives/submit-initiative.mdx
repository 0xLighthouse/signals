...
The simplest way to create an initiative is using `proposeInitiative`. You provide a title and detailed description (markdown supported). This creates the initiative without locking any tokens.
...
To immediately show support for your initiative, use `proposeInitiativeWithLock`. In addition to the title and description, you specify an amount of tokens to lock and a lock duration (measured in intervals).

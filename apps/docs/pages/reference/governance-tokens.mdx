...
Combine with minimum lock amount for dual requirements:
...
BoardConfig({
    ...
    proposerRequirements: ParticipantRequirements({
        ...
        minLockAmount: 10_000 * 1e18   // Must lock at least 10k
    })
})
```

Users must hold 100k tokens for 7 days AND lock at least 10k tokens to propose.

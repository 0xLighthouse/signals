...
export const experimentTokenAbi = [
  {
    type: 'constructor',
    inputs: [
      ...
      { name: 'allowanceSigner_', internalType: 'address', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: 'to', internalType: 'address', type: 'address' },
      { name: 'participantId', internalType: 'uint256', type: 'uint256' },
      { name: 'amount', internalType: 'uint256', type: 'uint256' },
...
export const experimentTokenFactoryAbi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: 'initialAllowanceSigner',
        internalType: 'address',
        type: 'address',
      },
    ],
